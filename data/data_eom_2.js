...
const data = {
    "index_1":{
        ...
        "paragraph_3":[
            ...
            {"image": true, "image_path": "./content/test_image.png", "img_sign": " "}
        ],
        "paragraph_4":[
    ...
    "index_2":{
        ...
        "test":[
            ...
            {"answers": [
                ...
                "Third Answer",
                "<p class='math_equation'>$$\\def\\d{\\mathrm{d}}\\oint_C \\vec{B}\\circ \\d\\vec{l} = \\mu_0 \\left( I_{\\text{enc}} + \\varepsilon_0 \\frac{\\d}{\\d t} \\int_S {\\vec{E} \\circ \\hat{n}}\\; \\d a \\right)$$</p>"
            ]},
            {"correct_answer": [1]},
